...
**21. 在 C 语言中，词法分析器遇到字符串 `"123abc"` 时，会将其识别为 ( )。**
...
**25. 有限自动机中，$\varepsilon$ 转换 the 含义是 ( )。**
...
**26. NFA 中的 $\varepsilon$-转换 (空转换) 表示 ( )。**
